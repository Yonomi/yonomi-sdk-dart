...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(GDeviceActionStatus.serializer)
      ..add(GDeviceDetailsData.serializer)
      ..add(GDeviceDetailsData_productInformation.serializer)
      ..add(GDeviceDetailsData_traits__asBatteryLevelDeviceTrait.serializer)
      ..add(
      ...
      ..add(
          GDeviceDetailsData_traits__asBatteryLevelDeviceTrait_state_percentage_reported
              .serializer)
      ..add(GDeviceDetailsData_traits__asBrightnessDeviceTrait.serializer)
      ..add(GDeviceDetailsData_traits__asBrightnessDeviceTrait_state.serializer)
      ..add(GDeviceDetailsData_traits__asBrightnessDeviceTrait_state_brightness
          .serializer)
      ..add(
      ...
      ..add(GDeviceDetailsData_traits__asLockDeviceTrait_state_isLocked_desired
          .serializer)
      ..add(GDeviceDetailsData_traits__asLockDeviceTrait_state_isLocked_reported
          .serializer)
      ..add(
          GDeviceDetailsData_traits__asPinCodeCredentialDeviceTrait.serializer)
      ..add(GDeviceDetailsData_traits__asPinCodeCredentialDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(
          GDeviceDetailsData_traits__asPinCodeCredentialDeviceTrait_state_pinCodeCredentials_reported_value_edges_node
              .serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait.serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait_properties.serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait_state.serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait_state_isOn.serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait_state_isOn_desired
          .serializer)
      ..add(GDeviceDetailsData_traits__asPowerDeviceTrait_state_isOn_reported
          .serializer)
      ..add(
          GDeviceDetailsData_traits__asThermostatSettingDeviceTrait.serializer)
      ..add(GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_properties
          .serializer)
      ..add(
      ...
      ..add(
          GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_properties_heatSetPointRange
              .serializer)
      ..add(GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(
          GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_state_fanMode_reported
              .serializer)
      ..add(GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_state_mode
          .serializer)
      ..add(
      ...
      ..add(
          GDeviceDetailsData_traits__asThermostatSettingDeviceTrait_state_targetTemperature_reported
              .serializer)
      ..add(GDeviceDetailsData_traits__base.serializer)
      ..add(GDeviceDetailsVars.serializer)
      ..add(GDeviceEventFilterInput.serializer)
      ..add(GDeviceEventSortInput.serializer)
      ...
      ..add(GgenerateAccountLinkingUrl.serializer)
      ..add(GgenerateAccountLinkingUrlData.serializer)
      ..add(GgenerateAccountLinkingUrlData_generateAccountLinkingUrl.serializer)
      ..add(GgenerateAccountLinkingUrlData_generateAccountLinkingUrl_integration
          .serializer)
      ..add(GgenerateAccountLinkingUrlVars.serializer)
      ..add(GgetAllIntegrations.serializer)
      ..add(GgetAllIntegrationsData.serializer)
      ..add(GgetAllIntegrationsData_integrations.serializer)
      ..add(GgetAllIntegrationsData_integrations_edges.serializer)
      ..add(GgetAllIntegrationsData_integrations_edges_node.serializer)
      ..add(GgetAllIntegrationsVars.serializer)
      ..add(GgetDevice.serializer)
      ..add(GgetDeviceData.serializer)
      ..add(GgetDeviceData_device.serializer)
      ..add(GgetDeviceData_device_productInformation.serializer)
      ..add(GgetDeviceData_device_traits__asBatteryLevelDeviceTrait.serializer)
      ..add(GgetDeviceData_device_traits__asBatteryLevelDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(
          GgetDeviceData_device_traits__asBatteryLevelDeviceTrait_state_percentage_reported
              .serializer)
      ..add(GgetDeviceData_device_traits__asBrightnessDeviceTrait.serializer)
      ..add(GgetDeviceData_device_traits__asBrightnessDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(
          GgetDeviceData_device_traits__asLockDeviceTrait_state_isLocked_reported
              .serializer)
      ..add(GgetDeviceData_device_traits__asPinCodeCredentialDeviceTrait
          .serializer)
      ..add(GgetDeviceData_device_traits__asPinCodeCredentialDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(
          GgetDeviceData_device_traits__asPinCodeCredentialDeviceTrait_state_pinCodeCredentials_reported_value_edges_node
              .serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait.serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait_properties
          .serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait_state.serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait_state_isOn
          .serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait_state_isOn_desired
          .serializer)
      ..add(GgetDeviceData_device_traits__asPowerDeviceTrait_state_isOn_reported
          .serializer)
      ..add(GgetDeviceData_device_traits__asThermostatSettingDeviceTrait
          .serializer)
      ..add(
      ...
      ..add(
          GgetDeviceData_device_traits__asThermostatSettingDeviceTrait_properties_heatSetPointRange
              .serializer)
      ..add(GgetDeviceData_device_traits__asThermostatSettingDeviceTrait_state
          .serializer)
      ..add(
      ...
      ..add(GgetDevicesData_me.serializer)
      ..add(GgetDevicesData_me_devices.serializer)
      ..add(GgetDevicesData_me_devices_edges.serializer)
      ..add(GgetDevicesData_me_devices_edges_node.serializer)
      ..add(GgetDevicesData_me_devices_edges_node_productInformation.serializer)
      ..add(
      ...
      ..add(
          GgetDevicesData_me_devices_edges_node_traits__asPinCodeCredentialDeviceTrait_state_pinCodeCredentials_reported_value_edges_node
              .serializer)
      ..add(GgetDevicesData_me_devices_edges_node_traits__asPowerDeviceTrait
          .serializer)
      ..add(
      ...
      ..add(GlinkedAccountsData_me_linkedAccounts.serializer)
      ..add(GlinkedAccountsData_me_linkedAccounts_edges.serializer)
      ..add(GlinkedAccountsData_me_linkedAccounts_edges_node.serializer)
      ...
      ..add(GmakeLockUnlockActionRequestData_actionLockSetLocked_device
          .serializer)
      ..add(
      ...
      ..add(
          GmakeSetModeRequestData_actionThermostatSettingSetThermostatMode_device_traits__base
              .serializer)
      ..add(GmakeSetModeRequestVars.serializer)
      ..add(GmakeSetTargetTemperatureRequest.serializer)
      ..add(GmakeSetTargetTemperatureRequestData.serializer)
      ..add(
      ...
      ..add(
          GmakeSetTargetTemperatureRequestData_actionThermostatSettingSetTargetTemperature_device_traits__base
              .serializer)
      ..add(GmakeSetTargetTemperatureRequestVars.serializer)
      ..add(GremoveLinkedAccount.serializer)
      ..add(GremoveLinkedAccountData.serializer)
      ..add(GremoveLinkedAccountData_removeLinkedAccount.serializer)
      ..add(GremoveLinkedAccountData_removeLinkedAccount_me.serializer)
      ..add(GremoveLinkedAccountVars.serializer)
      ..add(Guser.serializer)
      ..add(GuserData.serializer)
      ..add(GuserData_me.serializer)
      ..add(GuserData_tenant.serializer)
      ..add(GuserVars.serializer)
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(GDeviceDetailsData_traits)]),
          () => new ListBuilder<GDeviceDetailsData_traits>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<GgetDeviceData_device_traits>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(
                GgetDeviceData_device_traits__asPinCodeCredentialDeviceTrait_state_pinCodeCredentials_desired_delta_edges)
