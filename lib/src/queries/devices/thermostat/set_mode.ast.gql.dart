...
const makeSetModeRequest = _i1.OperationDefinitionNode(
    type: _i1.OperationType.mutation,
    name: _i1.NameNode(value: 'makeSetModeRequest'),
    variableDefinitions: [
...
const document = _i1.DocumentNode(definitions: [makeSetModeRequest]);
