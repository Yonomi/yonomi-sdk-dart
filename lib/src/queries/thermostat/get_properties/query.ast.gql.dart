...
const getThermostatSettingProperties = _i1.OperationDefinitionNode(
    type: _i1.OperationType.query,
    name: _i1.NameNode(value: 'getThermostatSettingProperties'),
    variableDefinitions: [
                      ...
                      selectionSet: _i1.SelectionSetNode(selections: [
                        _i1.FieldNode(
                            ...
                            selectionSet: _i1.SelectionSetNode(selections: [
                              ...
                              _i1.FieldNode(
                                  name:
                                      _i1.NameNode(value: 'availableFanModes'),
                                  alias: null,
                                  arguments: [],
                                  directives: [],
                                  selectionSet: null),
                              _i1.FieldNode(
                                  name:
                                      _i1.NameNode(value: 'heatSetPointRange'),
                                  alias: null,
                                  arguments: [],
                                  directives: [],
                                  selectionSet:
                              ...
                              _i1.FieldNode(
                                  name:
                                      _i1.NameNode(value: 'coolSetPointRange'),
                                  alias: null,
                                  arguments: [],
                                  directives: [],
                                  selectionSet:
...
const document =
    _i1.DocumentNode(definitions: [getThermostatSettingProperties]);
