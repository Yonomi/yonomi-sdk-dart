...
[GetDevices$Query$User$DeviceConnection$DeviceEdge](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/GetDevices$Query$User$DeviceConnection$DeviceEdge.md) ()

    

[GetDevices$Query$User$DeviceConnection$DeviceEdge.fromJson](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/GetDevices$Query$User$DeviceConnection$DeviceEdge.fromJson.md) ([Map](https://api.flutter.dev/flutter/dart-core/Map-class.html)&lt;[String](https://api.flutter.dev/flutter/dart-core/String-class.html), dynamic> json)
...
##### [node](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/node.md) &#8596; [GetDevices$Query$User$DeviceConnection$DeviceEdge$Device](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge$Device-class.md)
...
##### [props](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/props.md) &#8594; [List](https://api.flutter.dev/flutter/dart-core/List-class.html)&lt;[Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)>
...
this instance's <a href="../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/props.md">props</a>. [...](https://pub.dev/documentation/equatable/1.2.6/equatable/EquatableMixin/stringify.html)  
_read-only, inherited_
...
##### [toJson](../graphql_devices_devices_query.graphql/GetDevices$Query$User$DeviceConnection$DeviceEdge/toJson.md)() [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html)&lt;[String](https://api.flutter.dev/flutter/dart-core/String-class.html), dynamic>
